...
| ![Figure 5-2: A blank slate](./images/blank.png) |
| :----------------------------------------------: |
|          **Figure 5-2: A blank slate**           |
...
| ![Figure 5-3: The shader is being used to render a white full screen quad](./images/white.png) |
| :--------------------------------------------------------------------------------------------: |
|          **Figure 5-3: The shader is being used to render a white full screen quad**           |
...
| ![Figure 5-4: See the Progress parameter in the red value](./gifs/progress-parameter.gif) |
| :---------------------------------------------------------------------------------------: |
|                **Figure 5-4: See the Progress parameter in the red value**                |
...
| ![Figure 5-5: the x coordinate of each pixel represented in the red channel](./images/x-pos.png) |
| :----------------------------------------------------------------------------------------------: |
|          **Figure 5-5: the x coordinate of each pixel represented in the red channel**           |
...
| ![Figure 5-6: The y-coordinate of each pixel represented in the green channel](./images/y-pos.png) |
| :------------------------------------------------------------------------------------------------: |
|          **Figure 5-6: The y-coordinate of each pixel represented in the green channel**           |
...
| ![Figure 5-7: x and y coordinates in the red and green channels](./images/xy-pos.png) |
| :-----------------------------------------------------------------------------------: |
|           **Figure 5-7: x and y coordinates in the red and green channels**           |
...
| ![Figure 5-8: a simple horizontal screen wipe](./gifs/simple-x.gif) |
| :-----------------------------------------------------------------: |
|           **Figure 5-8: a simple horizontal screen wipe**           |
...
| ![Figure 5-9: A transparent screen wipe](./gifs/transparent-x.gif) |
| :----------------------------------------------------------------: |
|             **Figure 5-9: A transparent screen wipe**              |
...
| ![Figure 5-10: A smooth edge](./gifs/smoothstep.gif) |
| :-------------------------------------------------: |
|            **Figure 5-10: A smooth edge**            |
...
| ![Figure 5-11: A vertical screen wipe](./gifs/vertical.gif) |
| :---------------------------------------------------------: |
|           **Figure 5-11: A vertical screen wipe**           |
...
| ![Figure 5-12: A more interesting wipe](./gifs/center-wipe.gif) |
| :-------------------------------------------------------------: |
|            **Figure 5-12: A more interesting wipe**             |
...
| ![Figure 5-13: Just the value for the center wipe](./images/center-wipe-value.png) |
| :--------------------------------------------------------------------------------: |
|                **Figure 5-13: Just the value for the center wipe**                 |
...
| ![Figure 5-14: A sample gradient texture](./images/assets/ripple.png) |
| :-------------------------------------------------------------------: |
|              **Figure 5-14: A sample gradient texture**               |

| ![Figure 5-15: A sample gradient texture](./images/assets/angled.png) |
| :-------------------------------------------------------------------: |
|              **Figure 5-15: A sample gradient texture**               |

| ![Figure 5-16: A sample gradient texture](./images/assets/concave.png) |
| :--------------------------------------------------------------------: |
|               **Figure 5-16: A sample gradient texture**               |

| ![Figure 5-17: A sample gradient texture](./images/assets/radial.png) |
| :-------------------------------------------------------------------: |
...
| ![Figure 5-18: The concave value for a wipe](./images/concave-wipe-value.png) |
| :---------------------------------------------------------------------------: |
|                 **Figure 5-18: The concave value for a wipe**                 |
