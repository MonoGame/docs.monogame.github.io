...
5. When prompted for a version choose version `2026.5.2.1`.
...
6. On the right, in the version dropdown, select version `2026.5.2.1` and click the "Install" button.
...
2. Enter the following command:
    ...
    ```sh
    dotnet add DungeonSlime.csproj package Gum.MonoGame --version 2026.5.2.1
    ```
